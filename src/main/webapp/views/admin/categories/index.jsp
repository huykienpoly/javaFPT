      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <li><a class="dropdown-item" href="create">Đăng kí người dùng</a></li>
            <li><a class="dropdown-item" href="SOF3021-IT16306/admin/categories/create">Thêm mới loại sản phẩm </a></li>
             <li><a class="dropdown-item" href="SOF3021-IT16306/admin/products/create_pro">Thêm mới  sản phẩm </a></li>
          </ul>
        </li>
      </ul>
    </div>
...
<table class="table">
		...
		<c:forEach items="${ data.content }" var="cate">
			<tr>
				...
				<td>${ cate.name }</td>
								<td>
					<a href="/SOF3021-IT16306/admin/categories/edit/${ cate.id }" class="btn btn-primary">Update</a>
				</td>
				<td>
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-footer">
										...
										<a href="/SOF3021-IT16306/admin/categories/delete/${ cate.id }">
	...
	<div class="row">
				...
				<c:forEach var="i" begin="0" end="${ data.totalPages -1 }">
					<li class="page-item">
						<a class="page-link"
							href="/SOF3021-IT16306/admin/categories/index?page=${ i }">
							${ i + 1 }
						</a>
					</li>
				</c:forEach>
