...
<table class="table">
					...
					<c:forEach items="${ data.content }" var="order">
						<tr>
							...
							<td>
								<a href="/SOF3021-IT16306/admin/orders/edit_ord/${order.id }" class="btn btn-primary">Update</a>
							</td>
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-footer">
										...
										<a href="/SOF3021-IT16306/admin/orders/delete/${ order.id }">
	...
	<div class="row">
		...
		<c:forEach var="i" begin="0" end="${ data.totalPages - 1 }">
			<li class="page-item">
				<a class="page-link"
					href="/SOF3021-IT16306/admin/orders/index_ord?page=${ i }">
					${ i + 1 }
				</a>
			</li>
		</c:forEach>
